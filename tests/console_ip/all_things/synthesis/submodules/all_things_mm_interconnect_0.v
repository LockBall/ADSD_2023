// all_things_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module all_things_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [105:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sw_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // sw_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [105:0] jtag_master_master_agent_cp_data;                                                   // jtag_master_master_agent:cp_data -> router_002:sink_data
	...
	wire  [105:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [105:0] sw_s1_agent_rp_data;                                                                // sw_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [105:0] router_002_src_data;                                                                // router_002:src_data -> jtag_master_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                               // jtag_master_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [3:0] router_002_src_channel;                                                             // router_002:src_channel -> jtag_master_master_limiter:cmd_sink_channel
	...
	wire  [105:0] jtag_master_master_limiter_cmd_src_data;                                            // jtag_master_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	wire          jtag_master_master_limiter_cmd_src_ready;                                           // cmd_demux_002:sink_ready -> jtag_master_master_limiter:cmd_src_ready
	wire    [3:0] jtag_master_master_limiter_cmd_src_channel;                                         // jtag_master_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire  [105:0] rsp_mux_002_src_data;                                                               // rsp_mux_002:src_data -> jtag_master_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                                              // jtag_master_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [3:0] rsp_mux_002_src_channel;                                                            // rsp_mux_002:src_channel -> jtag_master_master_limiter:rsp_sink_channel
	...
	wire  [105:0] cmd_demux_002_src2_data;                                                            // cmd_demux_002:src2_data -> cmd_mux_003:sink1_data
	wire          cmd_demux_002_src2_ready;                                                           // cmd_mux_003:sink1_ready -> cmd_demux_002:src2_ready
	wire    [3:0] cmd_demux_002_src2_channel;                                                         // cmd_demux_002:src2_channel -> cmd_mux_003:sink1_channel
	...
	wire  [105:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> rsp_mux_002:sink2_data
	wire          rsp_demux_003_src1_ready;                                                           // rsp_mux_002:sink2_ready -> rsp_demux_003:src1_ready
	wire    [3:0] rsp_demux_003_src1_channel;                                                         // rsp_demux_003:src1_channel -> rsp_mux_002:sink2_channel
	...
	wire    [3:0] jtag_master_master_limiter_cmd_valid_data;                                          // jtag_master_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	all_things_mm_interconnect_0_router router (
	...
	all_things_mm_interconnect_0_router_001 router_001 (
	...
	all_things_mm_interconnect_0_router_002 router_002 (
	...
	all_things_mm_interconnect_0_router_003 router_003 (
	...
	all_things_mm_interconnect_0_router_004 router_004 (
	...
	all_things_mm_interconnect_0_router_005 router_005 (
	...
	all_things_mm_interconnect_0_router_005 router_006 (
	...
	all_things_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (clk_0_clk_clk),                                    //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),   //  clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                        //       clk.clk
		.reset               (sw_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                        //       clk.clk
		.reset              (sw_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	all_things_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
